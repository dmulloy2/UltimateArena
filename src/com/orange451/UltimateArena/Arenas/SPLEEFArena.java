...
public class SPLEEFArena extends FFAArena {
	...
	public SPLEEFArena(ArenaZone az) {
		...
		try{
			...
			spleefGround.setParam(pos1.getX(), pos1.getZ(), pos1.getY()-1, pos2.getX(), pos2.getZ(), pos2.getY()-1);
			...
			outZone.setParam(pos3.getX(), pos3.getZ(), pos3.getY()-1, pos4.getX(), pos4.getZ(), pos4.getY()-1);
		}catch(Exception e) {
			e.printStackTrace();
		}
	}
